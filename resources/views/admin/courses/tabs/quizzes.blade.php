<div class="mb-3 flex items-center justify-between">
    ...
    @if (Route::has('admin.quizzes.create'))
        <a href="{{ route('admin.quizzes.create') }}" class="text-sm text-[var(--color-primary)] hover:underline">اختبار جديد</a>
    @endif
</div>
        ...
        <li class="flex items-center justify-between py-2">
            ...
            <div class="flex gap-2">
                @if (Route::has('admin.quizzes.show'))
                    <a href="{{ route('admin.quizzes.show', $quiz) }}" class="text-[var(--color-primary)] hover:underline">عرض</a>
                @endif
