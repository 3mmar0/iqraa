<div class="mb-3 flex items-center justify-between">
    ...
    @if (Route::has('admin.assignments.create'))
        <a href="{{ route('admin.assignments.create') }}" class="text-sm text-teal-700 hover:underline">واجب جديد</a>
    @endif
</div>
        ...
        <li class="flex items-center justify-between py-2">
            ...
            <div class="flex gap-2">
                @if (Route::has('admin.assignments.show'))
                    <a href="{{ route('admin.assignments.show', $assignment) }}" class="text-teal-700 hover:underline">عرض</a>
                @endif
