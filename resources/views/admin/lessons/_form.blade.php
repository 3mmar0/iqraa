...
<div>
    ...
    <textarea id="description" name="description" rows="4" class="admin-input">{{ old('description', $l?->description) }}</textarea>
</div>
<div class="grid gap-4 sm:grid-cols-2">
    ...
    <div>
        <label class="admin-label" for="quiz_id">الاختبار المرتبط</label>
