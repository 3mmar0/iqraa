<form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-5">
    ...
    <label class="flex items-center gap-3 text-sm text-slate-700">
        ...
        <input type="checkbox" name="security_force_https" value="1" @checked(old('security_force_https', $settings['security.force_https'] ?? true)) class="rounded border-slate-300 text-teal-600">
        إجبار HTTPS
    </label>
