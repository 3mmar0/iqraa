...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-teal-900">الحملات</h1>
        @if (\Illuminate\Support\Facades\Route::has('marketing.campaigns.create'))
            <a href="{{ route('marketing.campaigns.create') }}" class="rounded bg-teal-700 px-4 py-2 text-sm text-white">حملة جديدة</a>
        @endif
    </div>
